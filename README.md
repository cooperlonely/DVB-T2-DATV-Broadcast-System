...
#
8 - u can also use mygica t230 series usb T2 tuner with custom driver (TBS6910se-debug in CrazyScan2 folder) for windows and unlock hardware 1.7MHz, or use CrazyScan2 software by CrazyCat with support 1.7MHz and other tools for analyze DVB-T2 Beacons.
