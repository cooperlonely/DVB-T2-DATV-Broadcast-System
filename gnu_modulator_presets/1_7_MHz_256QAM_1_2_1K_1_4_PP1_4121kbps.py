...
# Title: DVB-T2 1.7 MHz 256QAM 1/2
...
class DVB_1_7_MHz_256QAM_1_2_1K_1_4_PP1_4121kbps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DVB_1_7_MHz_256QAM_1_2_1K_1_4_PP1_4121kbps")
        ...
        self.dtv_dvbt2_interleaver_bb_0 = dtv.dvbt2_interleaver_bb(dtv.FECFRAME_NORMAL, dtv.C1_2, dtv.MOD_256QAM)
        ...
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(
            ...
            dtv.INBAND_ON)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_256QAM, 32, 3)
...
def main(top_block_cls=DVB_1_7_MHz_256QAM_1_2_1K_1_4_PP1_4121kbps, options=None):
