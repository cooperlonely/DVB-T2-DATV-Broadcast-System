...
# Title: DVB-T2 1.7 MHz 256QAM 5/6
...
class DVB_1_7_MHz_256QAM_5_6_1K_1_16_PP1_8388kbps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DVB_1_7_MHz_256QAM_5_6_1K_1_16_PP1_8388kbps")
        ...
        self.dtv_dvbt2_interleaver_bb_0 = dtv.dvbt2_interleaver_bb(dtv.FECFRAME_NORMAL, dtv.C5_6, dtv.MOD_256QAM)
        ...
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(
            ...
            dtv.INBAND_ON)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_256QAM, 39, 3)
...
def main(top_block_cls=DVB_1_7_MHz_256QAM_5_6_1K_1_16_PP1_8388kbps, options=None):
