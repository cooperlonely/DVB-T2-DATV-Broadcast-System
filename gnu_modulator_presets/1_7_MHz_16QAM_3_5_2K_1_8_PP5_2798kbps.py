...
# Title: DVB-T2 1.7 MHz 16QAM 3/5
...
class DVB_1_7_MHz_16QAM_3_5_2K_1_8_PP5_2798kbps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DVB_1_7_MHz_16QAM_3_5_2K_1_8_PP5_2798kbps")
        ...
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(
            ...
            dtv.INBAND_ON)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_16QAM, 18, 3)
...
def main(top_block_cls=DVB_1_7_MHz_16QAM_3_5_2K_1_8_PP5_2798kbps, options=None):
