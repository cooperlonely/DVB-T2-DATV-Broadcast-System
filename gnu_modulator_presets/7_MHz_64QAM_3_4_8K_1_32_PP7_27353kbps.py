...
class DVB_7_MHz_64QAM_3_4_8K_1_32_PP7_27353kbps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DVB_7_MHz_64QAM_3_4_8K_1_32_PP7_27353kbps")
        ...
        self.dtv_dvbt2_modulator_bc_0 = dtv.dvbt2_modulator_bc(dtv.FECFRAME_NORMAL, dtv.MOD_64QAM, dtv.ROTATION_ON)
        self.dtv_dvbt2_interleaver_bb_0 = dtv.dvbt2_interleaver_bb(dtv.FECFRAME_NORMAL, dtv.C3_4, dtv.MOD_64QAM)
        ...
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(
            ...
            dtv.INBAND_ON)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_64QAM, 140, 3)
...
def main(top_block_cls=DVB_7_MHz_64QAM_3_4_8K_1_32_PP7_27353kbps, options=None):
