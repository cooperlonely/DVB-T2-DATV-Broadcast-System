...
class DVB_8_MHz_64QAM_3_4_8K_1_32_PP7_32387kbps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DVB_8_MHz_64QAM_3_4_8K_1_32_PP7_32387kbps")
        ...
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(
            ...
            dtv.INBAND_ON)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_64QAM, 150, 3)
...
def main(top_block_cls=DVB_8_MHz_64QAM_3_4_8K_1_32_PP7_32387kbps, options=None):
